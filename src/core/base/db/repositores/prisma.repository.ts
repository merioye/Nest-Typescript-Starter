...
//       ? this.convertWhereToPrisma(options.where)
//       : {};
//     const select = options?.select
//       ? this.convertSelectToPrisma(options.select)
//       : undefined;
//     const include = options?.relations
//       ? this.convertRelationsToPrisma(options.relations)
//       : undefined;
//     const orderBy = options?.order
//       ? this.convertOrderToPrisma(options.order)
//       : undefined;
...
//     id: Entity[K],
//     options?: Omit<FindOneOptions<Entity>, 'where'> | undefined
//   ): Promise<Entity | null> {
//     const where: any = { id };
//     const select = options?.select
//       ? this.convertSelectToPrisma(options.select)
...
//     field: K,
//     options?: Omit<FindManyOptions<Entity>, 'select'> | undefined
//   ): Promise<Entity[K][]> {
//     const where = options?.where
//       ? this.convertWhereToPrisma(options.where)
//       : {};
...
//     records: PartialDeep<Entity, {}>[]
//   ): Promise<Entity[]> {
//     const prismaRecords = records.map((record) =>
...
//     const select = extraOptions?.select
//       ? this.convertSelectToPrisma(extraOptions.select)
//       : undefined;
//     const include = extraOptions?.relations
//       ? this.convertRelationsToPrisma(extraOptions.relations)
//       : undefined;
...
//     await this.model.updateMany(prismaUpdateArgs);
...
//     const update = this.convertUpdateData(updateOptions);
//     const select = extraOptions?.select
//       ? this.convertSelectToPrisma(extraOptions.select)
//       : undefined;
//     const include = extraOptions?.relations
...
//       ? this.convertWhereToPrisma(whereOptions)
//       : undefined;
//     const select = extraOptions?.select
//       ? this.convertSelectToPrisma(extraOptions.select)
//       : undefined;
...
//     try {
//       let deleteOperation = this.model.delete({
//         where,
//         select,
//         include,
//       });
...
//     const deletedEntities = await prismaModel.findMany({
//       where,
//       select: select || include ? { select, include } : undefined,
//     });
//     return deletedEntities as Entity[];
//   }

//   async softDeleteOne(options?: DeleteOptions<Entity>): Promise<Entity | null> {
//     const { where: whereOptions, options: extraOptions } = options || {};
...
//     // Prepare the Prisma query options
...
//     try {
//       const result = await this.model.update(queryOptions);
//       return result as Entity | null;
//     } catch (error: any) {
...
//     const result = await this.model.aggregate(prismaOptions);
...
//     return this.model.updateMany(prismaOptions);
//   }
...
//       ? this.convertWhereToPrisma(options.having)
//       : undefined;
...
//     if (!options.withDeleted && 'deletedAt' in this.model.fields) {
...
//     order: Partial<{ [P in keyof Entity]?: 'asc' | 'desc' }>
//   ): any {
