...
-- CreateIndex
CREATE UNIQUE INDEX "_BookPurchaser_AB_unique" ON "_BookPurchaser"("A", "B");

-- CreateIndex
CREATE INDEX "_BookPurchaser_B_index" ON "_BookPurchaser"("B");
...
-- AddForeignKey
ALTER TABLE "_BookPurchaser" ADD CONSTRAINT "_BookPurchaser_A_fkey" FOREIGN KEY ("A") REFERENCES "Book"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_BookPurchaser" ADD CONSTRAINT "_BookPurchaser_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
